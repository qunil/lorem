! function(a) {
    ...
    function f() {
        a(document).on("click", ".mkdf-like", function() {
            ...
            void 0 !== c.data("type") && (b = c.data("type"));
            var e = {
                action: "cortex_mikado_like",
                likes_id: d,
                type: b
            };
            a.post(mkdfLike.ajaxurl, e, function(a) {
                c.html(a).addClass("liked").attr("title", "You already like this!"), "portfolio_list" !== b && c.children("span").css("opacity", 1)
            });
            return !1
        })
    }
    var g = {};
    mkdf.modules.like = g, g.mkdfLikes = f, g.mkdfOnDocumentReady = b, g.mkdfOnWindowLoad = c, g.mkdfOnWindowResize = d, g.mkdfOnWindowScroll = e, a(document).ready(b), a(window).load(c), a(window).resize(d), a(window).scroll(e)
